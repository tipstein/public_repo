...
import std.range;
import common;
import std.file, std.csv, std.range;

struct BucketKNN(size_t Dim){   //this is the type <type>
    ...
    this(Point!Dim[] points, int nDivisions){  //points and number of splits
